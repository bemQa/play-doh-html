$(document).ready(function () {
    ...
    if($('.dropify').length) {
        $('.dropify').dropify({
            tpl: {
                preview: '<div class="dropify-preview work-wrapper"><span class="dropify-render work-img"></span><div class="dropify-infos"><div class="dropify-infos-inner"><p class="dropify-infos-message">{{ replace }}</p></div></div></div>',
                clearButton: '<button type="button" class="dropify-clear"><img src="img/close.png"></button>'
            }
        });
    }
});